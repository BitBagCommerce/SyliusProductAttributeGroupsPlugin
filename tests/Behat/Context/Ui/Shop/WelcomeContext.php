...
namespace Tests\BitBag\SyliusProductAttributeGroupsPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\BitBag\SyliusProductAttributeGroupsPlugin\Behat\Page\Shop\WelcomePageInterface;
